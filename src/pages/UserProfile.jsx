            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex border-b border-gray-200 mb-8">
                    <button
                        ...
                        className={`px-6 py-3 font-medium text-sm rounded-t-lg mr-2 transition-all ${activeTab === 'nfts' ? 'bg-emerald-600 text-white' : 'text-emerald-600 hover:bg-emerald-50'}`}
                    >
                        Mis NFTs
                    </button>
                    <button
                        onClick={() => setActiveTab('historial')}
                        className={`px-6 py-3 font-medium text-sm rounded-t-lg mr-2 transition-all ${activeTab === 'historial' ? 'bg-emerald-600 text-white' : 'text-emerald-600 hover:bg-emerald-50'}`}
                    >
                        Historial
                    </button>
                    <button
                        onClick={() => setActiveTab('reservas')}
                        className={`px-6 py-3 font-medium text-sm rounded-t-lg transition-all ${activeTab === 'reservas' ? 'bg-emerald-600 text-white' : 'text-emerald-600 hover:bg-emerald-50'}`}
                    >
                        Mis Reservas
                    </button>
                </div>
                                ...
                                >
                                    <div className="relative h-48 overflow-hidden">
                                        ...
                                        <div className="absolute bottom-0 left-0 p-4">
                                            ...
                                            <p className="text-emerald-200">{nft.location}</p>
                                        </div>
                                        <div className="absolute top-0 right-0 bg-white bg-opacity-90 rounded-bl-lg px-3 py-1 text-sm font-semibold text-emerald-700">
                                            {nft.valor}
                                        </div>
                                    </div>
                                    <div className="p-4">
                                        ...
                                        <div className="flex justify-between items-center">
                                            <span className="text-sm text-gray-500">Beneficio comunidad</span>
                                            <span className="text-sm font-bold text-emerald-600">{nft.beneficioComunidad}</span>
                                        </div>
                                    </div>
                                </div>
                            ))}
                        ...
                        <div className="bg-white rounded-xl shadow-md overflow-hidden">
                            <ul className="divide-y divide-gray-100">
                                {user.historial.map((item) => (
                                    <li
                                        key={item.id}
                                        className="p-5 hover:bg-emerald-50 transition-colors duration-200"
                                    >
                                        <div className="flex items-start">
                                            <div className={`flex-shrink-0 h-10 w-10 rounded-full flex items-center justify-center ${item.type === 'visita' ? 'bg-blue-100 text-blue-600' :
                                                    item.type === 'compra' ? 'bg-purple-100 text-purple-600' :
                                ...
                                >
                                    <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                                        <div className="mb-4 md:mb-0">
                                            <h3 className="text-xl font-bold text-gray-800">{reserva.lugar}</h3>
                                        ...
                                        <div className="flex flex-col space-y-2">
                                            ...
                                            <div className="bg-gray-50 p-2 rounded-lg">
                                                ...
                                                <p className="font-mono text-sm">{reserva.codigo}</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div className="mt-4 pt-4 border-t border-gray-100">
                                        <p className="text-sm text-gray-500">Hash del ticket:</p>
                                        <p className="font-mono text-sm text-gray-700 break-all">{reserva.ticketHash}</p>
                                    </div>
                                </div>
                            ))}
                        </div>
